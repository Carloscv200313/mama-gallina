...
export function ExpenseCreateForm({ categories, action }: { categories: Array<{ id: string; name: string }>; action: (state: ExpenseActionState, formData: FormData) => Promise<ExpenseActionState> }) {
