...
export default async function NewOrderPage({ searchParams }: { searchParams: Promise<{ tableId?: string; type?: string }> }) {
  ...
  return <OrderComposer catalog={catalog} table={table} initialOrderType={query.type === "takeaway" ? "takeaway" : table ? "dine_in" : "takeaway"} />;
}
